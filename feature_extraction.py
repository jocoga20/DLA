...
def main_save_feature_extraction():
	m = rework_model(torchvision.models.resnet18(weights=None), last_layer='linear', output_classes=43, do_freeze_backbone=False)
	...
	for i in tqdm(range(500)):
		X = eval(m, loader)
		torch.save(X, f'features/X{i}.pt')
